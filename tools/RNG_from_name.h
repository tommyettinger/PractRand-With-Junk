...
#define REGISTER_RNG_2(RNG) RNG_Factories::RNG_factory_index[ #RNG ] = _generic_two_parameter_RNG_factory<PractRand::RNGs::Polymorphic::NotRecommended:: RNG>;
		...
		REGISTER_RNG_0(rarns16)
			REGISTER_RNG_0(mover32)
			REGISTER_RNG_0(mover64)
			REGISTER_RNG_0(multimover32)
			REGISTER_RNG_0(thrust64a)
			REGISTER_RNG_0(xoroshiro32_32)
			REGISTER_RNG_0(xoroshiro16_16plus)
			REGISTER_RNG_0(xoshiro4x32)
			REGISTER_RNG_0(xoshiro5x32)
			REGISTER_RNG_0(xoshiro5x32long)
		...
		REGISTER_RNG_0(mulcr64)
			...
			REGISTER_RNG_0(mo_Cmres64)
			REGISTER_RNG_0(tiptoe64)
			REGISTER_RNG_0(thrust63)
			REGISTER_RNG_0(splitmix64)
			REGISTER_RNG_0(mulberry32)
			REGISTER_RNG_0(vortex)
			REGISTER_RNG_0(vortex2)
			REGISTER_RNG_1(vortex64)
			REGISTER_RNG_0(linnormA)
			REGISTER_RNG_2(linnormB)
			REGISTER_RNG_2(linnorm32)
